/* Generated by Cython 0.15.1 on Thu Mar 20 21:25:27 2014 */
...
#endif
#include <math.h>
#define __PYX_HAVE__arrayWrapper
#define __PYX_HAVE_API__arrayWrapper
#include "stdio.h"
#include "stdlib.h"
...
/*--- Type declarations ---*/
struct __pyx_obj_12arrayWrapper_ArrayWrapper;
...
struct __pyx_obj_12arrayWrapper_ArrayWrapper {
  PyObject_HEAD
  struct __pyx_vtabstruct_12arrayWrapper_ArrayWrapper *__pyx_vtab;
  void *data_ptr;
  int size;
};
...
struct __pyx_vtabstruct_12arrayWrapper_ArrayWrapper {
  PyObject *(*set_data)(struct __pyx_obj_12arrayWrapper_ArrayWrapper *, void *, int);
};
static struct __pyx_vtabstruct_12arrayWrapper_ArrayWrapper *__pyx_vtabptr_12arrayWrapper_ArrayWrapper;
...
static PyTypeObject *__pyx_ptype_12arrayWrapper_ArrayWrapper = 0;
static PyArrayObject *__pyx_f_12arrayWrapper_wrapPtr(void *, int, int); /*proto*/
#define __Pyx_MODULE_NAME "arrayWrapper"
int __pyx_module_is_main_arrayWrapper = 0;
...
static PyObject *__pyx_f_12arrayWrapper_12ArrayWrapper_set_data(struct __pyx_obj_12arrayWrapper_ArrayWrapper *__pyx_v_self, void *__pyx_v_data_ptr, int __pyx_v_size) {
...
static PyObject *__pyx_pf_12arrayWrapper_12ArrayWrapper___array__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static char __pyx_doc_12arrayWrapper_12ArrayWrapper___array__[] = " Here we use the __array__ method, that is called when numpy\n            tries to get an array from the object.\n        ";
static PyObject *__pyx_pf_12arrayWrapper_12ArrayWrapper___array__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
 ...
 */
  (__pyx_v_shape[0]) = ((npy_intp)((struct __pyx_obj_12arrayWrapper_ArrayWrapper *)__pyx_v_self)->size);
 ...
 * 
 */
  __pyx_t_1 = PyArray_SimpleNewFromData(1, __pyx_v_shape, NPY_INT, ((struct __pyx_obj_12arrayWrapper_ArrayWrapper *)__pyx_v_self)->data_ptr); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  __Pyx_AddTraceback("arrayWrapper.ArrayWrapper.__array__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
...
static PyArrayObject *__pyx_f_12arrayWrapper_wrapPtr(void *__pyx_v_array, int __pyx_v_size, int __pyx_v_typenum) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("wrapPtr");
 ...
 */
  __pyx_t_1 = PyArray_SimpleNewFromData(1, __pyx_v_shape, __pyx_v_typenum, __pyx_v_array); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 53; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("arrayWrapper.wrapPtr", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
static struct __pyx_vtabstruct_12arrayWrapper_ArrayWrapper __pyx_vtable_12arrayWrapper_ArrayWrapper;

static PyObject *__pyx_tp_new_12arrayWrapper_ArrayWrapper(PyTypeObject *t, PyObject *a, PyObject *k) {
  struct __pyx_obj_12arrayWrapper_ArrayWrapper *p;
  PyObject *o = (*t->tp_alloc)(t, 0);
  if (!o) return 0;
  p = ((struct __pyx_obj_12arrayWrapper_ArrayWrapper *)o);
  p->__pyx_vtab = __pyx_vtabptr_12arrayWrapper_ArrayWrapper;
  return o;
}

static void __pyx_tp_dealloc_12arrayWrapper_ArrayWrapper(PyObject *o) {
  (*Py_TYPE(o)->tp_free)(o);
}

static PyMethodDef __pyx_methods_12arrayWrapper_ArrayWrapper[] = {
  {__Pyx_NAMESTR("__array__"), (PyCFunction)__pyx_pf_12arrayWrapper_12ArrayWrapper___array__, METH_NOARGS, __Pyx_DOCSTR(__pyx_doc_12arrayWrapper_12ArrayWrapper___array__)},
  {0, 0, 0, 0}
};
...
static PyTypeObject __pyx_type_12arrayWrapper_ArrayWrapper = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("arrayWrapper.ArrayWrapper"), /*tp_name*/
  sizeof(struct __pyx_obj_12arrayWrapper_ArrayWrapper), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_12arrayWrapper_ArrayWrapper, /*tp_dealloc*/
  0, /*tp_print*/
  0, /*tp_getattr*/
  0, /*tp_setattr*/
  #if PY_MAJOR_VERSION < 3
  ...
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_12arrayWrapper_ArrayWrapper, /*tp_methods*/
  0, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  ...
  0, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_12arrayWrapper_ArrayWrapper, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initarrayWrapper(void); /*proto*/
PyMODINIT_FUNC initarrayWrapper(void)
#else
PyMODINIT_FUNC PyInit_arrayWrapper(void); /*proto*/
PyMODINIT_FUNC PyInit_arrayWrapper(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_arrayWrapper(void)");
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("arrayWrapper"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
  ...
  if (__pyx_module_is_main_arrayWrapper) {
  ...
  if (__Pyx_ExportFunction("wrapPtr", (void (*)(void))__pyx_f_12arrayWrapper_wrapPtr, "PyArrayObject *(void *, int, int)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  /*--- Type init code ---*/
  __pyx_vtabptr_12arrayWrapper_ArrayWrapper = &__pyx_vtable_12arrayWrapper_ArrayWrapper;
  __pyx_vtable_12arrayWrapper_ArrayWrapper.set_data = (PyObject *(*)(struct __pyx_obj_12arrayWrapper_ArrayWrapper *, void *, int))__pyx_f_12arrayWrapper_12ArrayWrapper_set_data;
  if (PyType_Ready(&__pyx_type_12arrayWrapper_ArrayWrapper) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_SetVtable(__pyx_type_12arrayWrapper_ArrayWrapper.tp_dict, __pyx_vtabptr_12arrayWrapper_ArrayWrapper) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_SetAttrString(__pyx_m, "ArrayWrapper", (PyObject *)&__pyx_type_12arrayWrapper_ArrayWrapper) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_12arrayWrapper_ArrayWrapper = &__pyx_type_12arrayWrapper_ArrayWrapper;
  /*--- Type import code ---*/
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init arrayWrapper", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init arrayWrapper");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
